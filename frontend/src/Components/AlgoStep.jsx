...
const AlgoStep = ({
  ...
  return (
    <div
      className={`self-stretch flex flex-col min-h-24 gap-2 m-1 outline-gray-300 outline outline-1 p-3 border-r-2 rounded-lg hover:bg-stone-50 transition-colors cursor-pointer`}
    >
      ...
      <div className="flex flex-row gap-1 items-center bg-green-200 rounded-xl self-stretch py-2 px-3">
